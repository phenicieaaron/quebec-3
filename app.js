...
app.get('/', async (req, res) => {
  ...
  client.connect;
  let mongoResult = await client.db("cuddly-palm-quebec").collection("dev_profiles").find().toArray();
...
app.post('/updateProfile', async (req, res) => {
  ...
  try {
    ...
    client.connect;
    const collection = client.db("cuddly-palm-quebec").collection("dev_profiles");
